...
app5 = Application.create(company: "Oracle", position: "Software Enginner I", status: "offer made", user_id: user1.id, favorite: false, logo_url: "https://sybyl.com/wp-content/uploads/2019/11/Oracle-Logo-For-Website.png")
...
app7 = Application.create(company: "Lyft", position: "Backend Software Enginnner", status: "wishlist", user_id: user1.id, favorite: false, logo_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Lyft_logo.svg/1200px-Lyft_logo.svg.png")
...
app10 = Application.create(company: "Netflix", position: "Software Enginner", status: "pending", user_id: user1.id, favorite: false, logo_url: "https://www.thewrap.com/wp-content/uploads/2021/07/Netflix-Logo-936x527.jpg")
...
Communication.create(time: datetime, received: false, comment: "Application submitted", application_id: app4.id)
Communication.create(time: datetime, received: true, comment: "Interview request received", application_id: app4.id)
Communication.create(time: datetime, received: false, comment: "Interview date confirmed", application_id: app4.id)

Communication.create(time: datetime, received: true, comment: "offer received", application_id: app5.id)
Communication.create(time: datetime, received: false, comment: "rejected", application_id: app6.id)
Communication.create(time: datetime, received: false, comment: "rejected", application_id: app8.id)
Communication.create(time: datetime, received: false, comment: "Interview request received", application_id: app9.id)
Communication.create(time: datetime, received: false, comment: "have not heard back", application_id: app10.id)
Communication.create(time: datetime, received: false, comment: "Application submitted", application_id: app11.id)
