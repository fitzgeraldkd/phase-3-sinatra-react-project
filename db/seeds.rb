...
app5 = Application.create(company: "Oracle", position: "React JS Developer", status: "pending", user_id: user1.id, favorite: false, logo_url: "https://sybyl.com/wp-content/uploads/2019/11/Oracle-Logo-For-Website.png")
